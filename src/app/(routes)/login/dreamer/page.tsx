...
const DreamerLogin = () => {
    ...
    return( 
        <NavBar match={false} explore={false} home={false} map={false} setting={false}>
            <CenterContainer className="h-screen">
                <VerticalStackContainer space={8} className="w-full m-4 lg:w-1/2 max-w-100 shadow-2xl p-8 lg:p-12 border-emerald-500 border-t-16">
                    ...
                    <VerticalStackContainer space={4}>
                        <VerticalStackContainer space={2}>
                            ...
                            <BaseInputText className="w-full" placeholder="Dreamer IDを入力してください" />
