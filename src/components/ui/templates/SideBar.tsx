...
export const SideBar = ({children}: {children: React.ReactNode}) => {
    return(
        <HorizontalStackContainer>
            <VerticalStackContainer space={8} className="h-screen w-80 p-4">
                <div>
                    <h2 className="font-bold">Karynos</h2>
                </div>

                <VerticalStackContainer space={2}>
                    <p className="font-semibold text-zinc-500 text-sm">メインメニュー</p>
                ...
                <VerticalStackContainer space={2}>
                    <p className="font-semibold text-zinc-500 text-sm">管理機能</p>
                    <SideBarButton icon={faGear} active={false}>設定</SideBarButton>
                </VerticalStackContainer>
                <VerticalStackContainer space={2}>
                    <p className="font-semibold text-zinc-500 text-sm">サポート</p>
