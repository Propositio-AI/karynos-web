...
export const SignUpForm = ({
	...
	return (
		<CenterContainer className="min-h-screen bg-canvas px-5 py-10">
			<VerticalStackContainer
				className="w-full max-w-md rounded-(--radius-lg) border border-line bg-surface p-8"
				space={8}
			>
				<div>
				...
				<AnimatePresence mode="wait">
					<FadeInAnimation>
						...
						{error && (
							<div
								className="mt-4 rounded-(--radius-sm) border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-600"
								role="alert"
							>
								{error}
							</div>
