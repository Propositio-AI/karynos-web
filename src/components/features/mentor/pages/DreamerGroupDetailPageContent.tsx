...
export default function DreamerGroupDetailPageContent() {
			...
			<div className="bg-canvas p-8 flex-1">
				...
				>
					<HorizontalStackContainer className="w-full p-8">
						<img
							alt="User Icon"
							src="https://www.figma.com/api/mcp/asset/6ee632ba-ade1-40f4-ae60-7d8c9991cbd1"
							className="w-14 h-14"
						/>
